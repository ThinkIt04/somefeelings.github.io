      ...
      document.getElementById("car1").innerHTML = `<div class="overlay"></div><img src="Images/im1.jpg" class="card-img-top" alt="My First Love Is My Mom"><div class="card-body"><h5 class="card-title">My First Love Is My Mom</h5></div>`;
      document.getElementById("car2").innerHTML = `<div class="overlay"></div><img src="Images/im3.jpg" class="card-img-top" alt="Our Mother, The Nature"><div class="card-body"><h5 class="card-title">Our Mother, The Nature</h5></div>`;
      document.getElementById("car3").innerHTML = `<div class="overlay"></div><img src="Images/im5.jpg" class="card-img-top" alt="दोस्ती"><div class="card-body"><h5 class="card-title">दोस्ती</h5></div>`;
      document.getElementById("car4").innerHTML = `<div class="overlay"></div><img src="Images/im2.jpg" class="card-img-top" alt="पौधे और किसान"><div class="card-body"><h5 class="card-title">पौधे और किसान</h5></div>`;
      document.getElementById("car5").innerHTML = `<div class="overlay"></div><img src="Images/im4.jpg" class="card-img-top" alt="आ जाने से तुम्हारे"><div class="card-body"><h5 class="card-title">आ जाने से तुम्हारे</h5></div>`;
      document.getElementById("car6").innerHTML = `<div class="overlay"></div><img src="Images/im6.jpg" class="card-img-top" alt="करता है सलाम"><div class="card-body"><h5 class="card-title">करता है सलाम</h5></div>`;
