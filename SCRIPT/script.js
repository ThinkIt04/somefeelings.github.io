      ...
      document.getElementById("car3").innerHTML = `<div class="overlay"></div><img src="https://lh3.googleusercontent.com/proxy/koTLCbLH9S8Bd34vsX_dVOsj6DEuRU7BeJN3_yQi3tqyNzYsjTXAqviObZdNINS8818WzcRH45uJjY2g1ym2CgVe" class="card-img-top" alt="दोस्ती"><div class="card-body"><h5 class="card-title">दोस्ती</h5></div>`;
      document.getElementById("car4").innerHTML = `<div class="overlay"></div><img src="https://lh3.googleusercontent.com/proxy/5WRKk19n4TteafS5Oagf_hGPQ-aNQ4JCgCRQfYiqs-qC91tHrwmTg3HbVfPJYb8TZRsvaxwpODylJDZiWLHRI09s" class="card-img-top" alt="पौधे और किसान"><div class="card-body"><h5 class="card-title">पौधे और किसान</h5></div>`;
      document.getElementById("car5").innerHTML = `<div class="overlay"></div><img src="https://image.shutterstock.com/image-vector/rainy-season-two-girls-park-260nw-530100706.jpg" style="clip-path: polygon(0 0%, 100% 0%, 100% 93%, 0 93%);" class="card-img-top" alt="आ जाने से तुम्हारे"><div class="card-body"><h5 class="card-title">आ जाने से तुम्हारे</h5></div>`;
      document.getElementById("car6").innerHTML = `<div class="overlay"></div><img src="https://static.toiimg.com/photo/msid-75652875/75652875.jpg?3065886" class="card-img-top" alt="करता है सलाम"><div class="card-body"><h5 class="card-title">करता है सलाम</h5></div>`;
